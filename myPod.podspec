...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Alextrancex" => "rca_230594@hotmail.com" }
  # Or just: spec.author    = "Alextrancex"
  # spec.authors            = { "Alextrancex" => "rca_230594@hotmail.com" }
  # spec.social_media_url   = "https://twitter.com/Alextrancex"
